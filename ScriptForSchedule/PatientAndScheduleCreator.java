		...
		try {
			if(args.length < 3) {
				...
				System.out.println("3rd - trial id (Currently for comapass only "
						+ "5a946ff566684905df608446 is used) ");
			...
			System.out.println("Do you want to create "+numberOfPatients+" patients ? (Y/N)");
			...
			if(res.equalsIgnoreCase("y") || res.equalsIgnoreCase("yes")) {
				...
				System.out.println("Do you want to create schedule for all these patients ? (Y/N)");
				...
				if(res1.equalsIgnoreCase("y") || res1.equalsIgnoreCase("yes")) {
					...
					for(Integer i : patientPins) {
						...
						ClientResponse scheduleRes = webPatientSchedule.type("application/json")
					...
					System.out.println("You have sucessfully created patients and their schudules.");
					System.out.println("List of patients : " + patientPins );
					System.out.println("Bye.");
				}else {
					System.out.println("You have sucessfully created patients.");
			...
			System.out.println("OOPPSSS ...GOT BELOW EXCEPTION..");
			e.printStackTrace();
		}
	}
